...
public class PreSignupJwtFilter extends OncePerRequestFilter {

    private final JwtUtil jwtUtil;

    public PreSignupJwtFilter(JwtUtil jwtUtil) {
        this.jwtUtil = jwtUtil;
    }

    @Override
    protected boolean shouldNotFilter(HttpServletRequest request) {
        return !request.getRequestURI().equals("/robssohex/auth/complete-signup");
    }
